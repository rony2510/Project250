...
<head>
  ...
  <title>Archive-Complains</title>
  
</head>
<body>

  <div class="container">
    <p style="text-align:center;color:darkcyan;font-size: 30px;">Complains Archive</p>
  ...
  <?php
    ...
    $sql="SELECT id,name,email,hall,room,date,complain FROM complainhistory";

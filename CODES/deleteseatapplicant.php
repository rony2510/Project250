...
<!-- Admin -->
    ...
    <div class="container" style="background-color: #1d2834;text-align: center;margin-top:50px">
      <p style="color: rgb(30, 227, 209);font-size: 25px;">Delete Seat Applicant</p>
      <hr style=" width: 70%;margin-left: auto;margin-right: auto;border-top:1px solid white;">
    </div>


    <div class="container">
      <form action="deleteseatapplicantprocess.php" method="post">
        <label style="color:white">Enter Registration Number:</label>
        <input type="number" name="reg" placeholder="Enter Registration" required>

...
<!-- main body -->
  <div class="container" style="background-color: #1d2834;text-align: ;margin-top:50px">
    <div style="border:1px solid white;width:60%;border-radius: 50px;margin: auto;padding: ;background-color: #228b22;">
      <p style="color: black;font-size: 25px;text-align: center;margin: auto;">Complain</p>
    </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="card my-auto shadow" style="width:400px;">
        ...
        <div class="card-body">
          <form action="complainprocess.php" method="post">
            <div class="form-group">
              <label for="complain">Complain</label><br>
              <textarea name="complain" rows="5" placeholder="Write Your Complain Here" class="form-control"></textarea required><br>
            </div>
            <br>
...
<!-- logout -->
  <br><br>
      <div class="container" style="width:20%;border-radius: 50px;border: 1px solid black;background-color: darkmagenta;">
        <p style="text-align:center;font-size:20px;margin: auto;"><a href="logoutadmin.php" style="text-decoration:none;color:black;">Log Out</a></p>
      </div>

...
<!-- BOOTSTRAP 4 -->
  ...
  <title><?php echo "Administration-Add Notice"; ?></title>
</head>
<body>
...
<!-- Admin -->
    ...
    <div class="container" style="background-color: #1d2834;text-align: center;margin-top:50px">
      <p style="color: rgb(30, 227, 209);font-size: 25px;">Add Notice</p>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="card my-auto shadow" style="width:400px;">
        ...
        <div class="card-body">
          <form action="addnoticeprocess.php" method="post">
            <div class="form-group" style="width:";>
              <label for="name">Notice</label><br>
              <textarea class="form-control" name="notice" rows="5" placeholder="Write Notice" required></textarea>
            </div>
            <br>

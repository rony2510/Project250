...
<div class="bgg">
  ...
  <div class="container" style="background-color: #1d2834;text-align: ;margin-top:50px">
    <div style="border:1px solid white;width:60%;border-radius: 50px;margin: auto;padding: ;background-color: #228b22;">
      <p style="color: black;font-size: 25px;text-align: center;margin: auto;">Sign Up</p>
    </div>
        ...
        <div class="card-body">
          <form action="registervalidate.php" method="post">
            ...
            <div class="form-group">
              ...
              <input type="password" id="password" name="confirmpassword" class="form-control" value="" placeholder="Cnfirm Password" required>
            </div>
            </div>
            <br>
            <input type="submit" name="" value="Register" class="btn btn-primary w-100">
          </form>
        </div>

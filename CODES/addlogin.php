...
<!-- BOOTSTRAP 4 -->
  ...
  <title><?php echo "Add Student LogIn-Administration"; ?></title>
</head>
<body>
...
<!-- Admin -->
    ...
    <div class="container" style="background-color: #1d2834;text-align: center;margin-top:50px">
      <p style="color: rgb(30, 227, 209);font-size: 25px;">Add LogIn Credential</p>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="card my-auto shadow" style="width:400px;">
        ...
        <div class="card-header text-center">
          <h4>Add LogIn Credential</h4>
        </div>
        <div class="card-body">
          <form action="addloginprocess.php" method="post">

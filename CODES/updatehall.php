...
<!-- Admin -->
    ...
    <div class="container" style="background-color: #1d2834;text-align: center;margin-top:50px">
      <p style="color: rgb(30, 227, 209);font-size: 25px;">Update Hall</p>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="card my-auto shadow" style="width:400px;">
        ...
        <div class="card-body">
          <form action="updatehallprocess.php" method="post">
            <div class="form-group" style="width:";>
              ...
              <textarea class="form-control" name="detail" rows="5" placeholder="Update detail" required></textarea>
            </div>
            <br>
